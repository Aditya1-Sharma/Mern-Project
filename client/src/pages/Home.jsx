      ...
      {/* top */}
        <div className='flex flex-col gap-6 p-28 px-3  max-w-6xl mx-auto'>
          ...
          <div className="text-gray-400 text-xs sm:text-sm">
            Aditya Estate is the best place to find your next perfecr place to live. <br />
            ...
            offerListings.map((listing) =>(
              <SwiperSlide key={listing._id}>
                <div style={{background: `url(${listing.imageUrls[0]}) center no-repeat`
                 , backgroundSize:'cover'}} className='h-[550px]' >
                </div>
              </SwiperSlide>
            ))
          }
        ...
        {saleListings && saleListings.length>0 && (
          <div className="my-3">
            <div className="text-2xl font-semibold text-slate-500">
              ...
              <Link to= {'/search?sale=true'} className='text-sm text-blue-800 hover:underline'>
